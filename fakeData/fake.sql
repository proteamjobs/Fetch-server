...
INSERT INTO orders
    ...
    _id,
    name
    , destination, price, due, quantity, preferParcel, description, referenceUrl, buyer_id, status, parcel_id, createdAt, updatedAt)
VALUES
    (1, 'FILA 트레이닝 세트', 'japan', 80000, '2019-06-30', 1, 1, '일본 후쿠오카에서 판다고 하네요. 사다주세요', NULL, 3, 0, NULL, '2019-05-31 10:30:20', '2019-05-31 10:30:20'),
    (2, '아디다스 이지부스터', 'USA', 700000, '2019-06-15', 1, 1, '미국 LA에서 판다고 하네요. 사다주세요!!!!!!', NULL, 4, 0, NULL, '2019-05-31 10:32:18', '2019-05-31 10:32:18'),
    (3, '구찌 라이톤', '영국', 1300000, '2019-07-04', 1, 1, '영국 런던에서 판다고 하네요. 사다주세요ㅎㅎㅎㅎㅎ', NULL, 5, 0, NULL, '2019-05-31 10:34:28', '2019-05-31 10:34:28'),
    (4, '구찌 벨트', '일본', 60000, '2019-07-17', 1, 1, '일본 도쿄에서 판다고 하네요. 사다주세요ㅋ', NULL, 3, 0, NULL, '2019-05-31 10:58:31', '2019-05-31 10:58:31'),
    (5, '박세현의 티셔츠', '제주도', 10000000, '2019-07-20', 1, 1, '한국 제주도에서 판다고 하네요. 너무사고싶어요!!', NULL, 4, 0, NULL, '2019-05-31 10:59:45', '2019-05-31 10:59:45'),
    (6, '허다영의 양말', '프랑스', 300000, '2019-08-29', 1, 1, '프랑스 파리에서 판다고 하네요. 한번 구해봐주세요', NULL, 5, 0, NULL, '2019-05-31 11:00:30', '2019-05-31 11:00:30'),
    (7, '정슬아의 안경', '스위스', 60000000, '2019-08-30', 1, 1, '스위스에서 판다고 하네요. 구해주세요 제발요', NULL, 3, 0, NULL, '2019-05-31 11:01:09', '2019-05-31 11:01:09'),
    (8, '유요한의 셔츠', '체코', 60000000, '2019-08-10', 1, 1, '체코에서 판다고 하네요. 급해요 !!!', NULL, 4, 0, NULL, '2019-05-31 11:01:40', '2019-05-31 11:01:40'),
    (9, '오레오오즈', '미국', 20000, '2019-06-14', 3, 1, '미국에서 파는 오레오오즈가 먹고싶어요 사다주세요!', NULL, 5, 0, NULL, '2019-06-01 08:47:51', '2019-06-01 08:47:51'),
    (10, '초코칩 쿠키', '베트남', 13000, '2019-07-02', 10, 1, '베트남에서 파는 초코칩 쿠키가 그렇게 맛나다면서요? 꼭 먹어보고 싶어요 사다주세요 빨리요 현기증나요', NULL, 3, 0, NULL, '2019-06-01 08:56:42', '2019-06-01 08:56:42');
